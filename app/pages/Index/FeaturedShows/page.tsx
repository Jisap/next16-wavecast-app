                    ...
                    <div className="w-full lg:w-1/2">
                      <div className="p-5">
                        <div className="flex flex-col lg:flex-row justify-between items-center">
                          <span className="bg-gray px-5 py-2 rounded-full text-prim font-semibold tracking-wide">
                            {item.episode}
                          </span>

                          <Link href="/app/pages">
                            <p className="py-2 font-light text-gray-200 hover:text-prim tracking-wider transition-all duration-200">
